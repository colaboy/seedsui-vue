...
<Page>
  ...
  <Container>
    ...
    <p class="description">箭头</p>
    <div class="box box-center" style="padding:8px;">
      <div class="arrow-top arrow-center" style="position:relative;padding:10px;border-radius:3px;background-color: #b8daff;display:inline-block;">
        <p>箭头</p>
      </div>
    </div>

    <p class="description">向上的三角</p>
    <div class="box box-center" style="padding:8px;">
      <div class="triangle-up"></div>
    </div>

    <p class="description">向左的三角</p>
    <div class="box box-center" style="padding:8px;">
      <div class="triangle-left"></div>
    </div>

    <p class="description">向下的三角</p>
    <div class="box box-center" style="padding:8px;">
      <div class="triangle-down"></div>
    </div>

    <p class="description">向右的三角</p>
    <div class="box box-center" style="padding:8px;">
      <div class="triangle-right"></div>
    </div>

    <p class="description">等边三角</p>
    <div class="box box-center" style="padding:8px;">
      <div class="triangle-eq"></div>
    </div>

    <p class="description">五边形向下</p>
    <div class="box box-center" style="padding:8px;">
      <div class="pentagon-down"></div>
    </div>

    <p class="description">菱形</p>
    <div class="box box-center" style="padding:8px;">
      <div class="rhombus"></div>
    </div>

    <p class="description">菱形六边形</p>
    <div class="box box-center" style="padding:8px;">
      <div class="hexagon">
        <!--菱形六边形-->
    ...
    <p class="description">漏斗</p>
    <div class="box box-center" style="padding:8px;">
      <div class="funnel"></div>
    </div>

    <p class="description">平等四边形</p>
    <div class="box box-center" style="padding:8px;">
      <div class="parallelogram"></div>
    </div>

    <p class="description">十二星形</p>
    <div class="box box-center" style="padding:8px;">
      <div class="twelve-point-star"></div>
    </div>

    <p class="description">六星形</div>
    <div class="box box-center" style="padding:12px 0 48px 0;">
      <div class="six-point-star"></div>
    </div>

    <p class="description">六边形</p>
    <div class="box box-center" style="padding:8px;">
      <div class="octagon"></div>
    </div>

    <p class="description">鸡蛋</p>
    <div class="box box-center" style="padding:8px;">
    ...
    <p class="description">不完整的圆</p>
    <div class="box box-center" style="padding:8px;">
      <div class="pacman"></div>
    </div>

    <p class="description">八卦圆</p>
    <div class="box box-center" style="padding:8px;">
      <div class="biohazard"></div>
    </div>

    <p class="description">心形</p>
    <div class="box box-center" style="padding:8px;">
      <div class="heart"></div>
    </div>

    <p class="description">clip</p>
    <div class="box box-center" style="padding:8px;">
      <div class="arrowr"></div>
    </div>

    <p class="description">地图标记</p>
    <div class="box box-center" style="padding:8px;">
      <div class="pin">
        <label class="pin-label">1</label>
      </div>
    </div>
  </Container>
</Page>
...
<style scoped>
  ...
  .arinputbox-left:after {
    right: 100%;
    border-right-color: #b8daff;
  }

  .arinputbox-right:after {
    left: 100%;
  ...
  /*clip*/
  .arrowr {
    background-image: url(http://mat1.gtimg.com/jiangsu/index_201704/img/logo.png);
